...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  <head>
    <title>PHP ejemplo para APIS de APIcultur. Ejercicios de ortografía G - J</title>
  ...
  <body>
    <div>
      ...
      <h1>Ejercicios de ortografía G - J</h1>

      <p>Contesta a las siguientes preguntas con G o J según corresponda pulsando sobre la letra que creas correcta</p>
...
?>
	...
	<p>
      <form action="ejercicio_ortografia_gj.php" method="POST" name="theform">
...
<?php   
 ...
 function obtenerPreguntas($numPreguntas,$dificultad,$nivel) {
	...
	$url="https://store.apicultur.com/api/ejercicioortografiagj/1.0.0/".$numPreguntas."/".$dificultad."/".$nivel;		
